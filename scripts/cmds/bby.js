        ...
        if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
            ...
            const getBotResponse = async (text, attachments) => {
                ...
                const randomMessage = [
                                ...
                                "jaw amr boss protik k message daw ",
                                ...
                                "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার বস মানে, protik ,protik বলে ও তো ডাকতে পারো😑?",
                                ...
                                "__ফ্রী ফে'সবুক চালাই কা'রন জেলিফিস : ঠাষণুবা :  মুখ দেখা হারাম 😌",
